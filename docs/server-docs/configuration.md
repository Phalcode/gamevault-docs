...
| `SERVER_SERVER_MAX_DOWNLOAD_BANDWIDTH_IN_KBPS` | Maximum bandwidth for downloads on this server in KB/s. ⚠️ CAUTION: Too high number may crash the server upon game download.                                        | `10485760` (10 GiB/s) | Any Number                                                                                   |
