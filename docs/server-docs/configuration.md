...
| `GAMES_SEARCH_EXCLUDE_FILE_REGEX`                | Regular expression used to exclude matching filenames from indexing. The match is applied to the filename (basename) only.                                                                                                                                                                                                                                                                            | -                                                                   | Any valid JavaScript regex pattern string |
| `GAMES_SEARCH_EXCLUDE_DIR_REGEX`                 | Regular expression used to exclude matching directory names from recursive indexing. The match is applied to each directory name (basename).                                                                                                                                                                                                                                                          | -                                                                   | Any valid JavaScript regex pattern string |
