...
| `AUTH_OAUTH2_CALLBACK_URL`      | The OAuth2 callback/redirect URL to GameVault. This should be the URL of your GameVault server + `/api/auth/oauth2/login` (e.g. `https://demo.gamevau.lt/api/auth/oauth2/login`) | -                                     | This should be the URL of your GameVault server + `/api/auth/oauth2/login`  |
