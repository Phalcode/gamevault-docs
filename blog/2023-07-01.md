---
title: "Introducing Crackpipe 🚀 - The self-hosted Alternative to Traditional Game Platforms"
authors: [alfagun74]
tags:
  [
    gaming,
...
Our team has been working tirelessly for the past year on creating Crackpipe, the source-available, decentralized, self-hosted, and free alternative to traditional cloud-based game platforms like Steam, Origin, Epic Games, and GoG. We are excited to share that Crackpipe is now available for everyone to use, and we are delighted to disclose it to the community.
